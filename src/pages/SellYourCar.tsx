...
export default function SellYourCar() {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col">
            <Header />
            <SEO title="Sell Your Car for Cash or Trade-In Value" description="Want to sell your car in Ontario? Get a top-dollar cash offer or trade-in value at Car Street. Fast, fair appraisals with no obligation." url="https://carstreet.ca/sell-your-car" />
